...
class LfNetworkCopyFieldGuardTest {
    ...
    void testCopyGraphFieldInventory() {
        ...
        expected.put(LfBusImpl.class, Set.of("busRef", "id", "voltageLevelId", "nominalV", "lowVoltageLimit", "highVoltageLimit", "participating", "breakers", "country", "bbsIds", "fictitiousInjectionTargetP", "fictitiousInjectionTargetQ", "violationLocation", "violationLocationComputed", "mergedBusIds"));
        ...
        expected.put(LfGeneratorImpl.class, Set.of("generatorRef", "id", "minP", "maxP", "initialTargetQ", "reactiveLimits", "initialParticipating", "participating", "droop", "participationFactor", "qPercent", "isTargetQForcedInReactiveLimits", "forceVoltageControl", "maxTargetP", "minTargetP", "forceTargetQInReactiveLimits"));
        expected.put(LfBatteryImpl.class, Set.of("batteryRef", "id", "minP", "maxP", "initialTargetQ", "reactiveLimits", "initialParticipating", "participating", "droop", "participationFactor", "maxTargetP", "minTargetP"));
        ...
        expected.put(LfLoadImpl.class, Set.of("bus", "loadModel", "loadsRefs", "lccCsRefs", "loadsInfos", "lccCsIds", "targetQ", "ensurePowerFactorConstantByLoad", "loadsAbsVariableTargetP", "absVariableTargetP", "distributedOnConformLoad", "loadsDisablingStatus", "p", "q"));
