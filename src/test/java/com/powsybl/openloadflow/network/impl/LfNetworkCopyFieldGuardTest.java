...
class LfNetworkCopyFieldGuardTest {
    ...
    void testCopyGraphFieldInventory() {
        ...
        expected.put(AbstractLfBus.class, Set.of("slack", "reference", "v", "calculatedV", "angle", "hasGeneratorsWithSlope", "generatorVoltageControlEnabled", "generatorReactivePowerControlEnabled",
                "generationTargetP", "generationTargetPValid", "generationTargetQ", "invalidatedGenerationTargetQ", "qLimitType", "generators", "converters", "shunt", "controllerShunt", "svcShunt",
                "distributedOnConformLoad", "loads", "loadTargetP", "loadTargetPValid", "loadTargetQ", "branches", "hvdcs", "generatorVoltageControl", "generatorReactivePowerControl",
        ...
        expected.put(AbstractLfAcDcConverter.class, Set.of("calculatedPac", "calculatedQac", "calculatedIconv1", "calculatedIconv2", "targetP", "pAc", "qAc", "lossFactors", "targetVdc", "controlMode",
                "dcBus1", "dcBus2", "bus1"));
