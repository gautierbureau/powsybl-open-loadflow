 ...
 * security analyses to restore only the elements actually impacted by a contingency (and the associated operator
 * strategy actions) instead of the whole network after each contingency.
 *
